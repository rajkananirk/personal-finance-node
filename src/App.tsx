...
function App() {
    ...
    const caseStudies = [
        {
            "category": "E-commerce",
            bg: "bg-blue-500", text: "text-white", labelBg: "bg-blue-100", labelText: "text-blue-600",
            "title": "Boosting Sales with Personalized Recommendations",
            "description": "An online store increased its sales by 35% by implementing AI-driven personalized product recommendations. The solution analyzed user behavior and suggested products tailored to each customer's preferences.",
            "image": "https://images.unsplash.com/photo-1592503254549-d83d24a4dfab?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            "category": "Healthcare",
            bg: "bg-green-500", text: "text-white", labelBg: "bg-green-100", labelText: "text-green-600",
            "title": "Improving Patient Outcomes with Telemedicine",
            "description": "A healthcare provider implemented a telemedicine platform to offer remote consultations, reducing patient wait times by 50% and improving patient satisfaction.",
            "image": "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8SGVhbHRoY2FyZXxlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            "category": "Education",
            bg: "bg-purple-500", text: "text-white", labelBg: "bg-purple-100", labelText: "text-purple-600",
            "title": "Enhancing Learning Through Gamification",
            "description": "An educational platform increased student engagement by 40% by integrating gamification techniques such as quizzes, badges, and leaderboards.",
            "image": "https://plus.unsplash.com/premium_photo-1677567996070-68fa4181775a?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8RWR1Y2F0aW9ufGVufDB8fDB8fHww"
        },
        {
            "category": "Finance",
            bg: "bg-pink-500", text: "text-white", labelBg: "bg-pink-100", labelText: "text-pink-600",
            "title": "Fraud Detection Using Machine Learning",
            "description": "A financial institution reduced fraudulent transactions by 70% by implementing a machine learning model that analyzes transaction patterns in real-time.",
            "image": "https://plus.unsplash.com/premium_photo-1679923813998-6603ee2466c5?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8RmluYW5jZXxlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            "category": "Marketing",
            bg: "bg-indigo-500", text: "text-white", labelBg: "bg-indigo-100", labelText: "text-indigo-600",
            "title": "Driving Brand Awareness with Influencer Marketing",
            "description": "A startup increased its brand awareness by 60% through strategic influencer partnerships, reaching a wider audience across social media platforms.",
            "image": "https://images.unsplash.com/photo-1562577309-4932fdd64cd1?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjd8fE1hcmtldGluZ3xlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            "category": "Retail",
            bg: "bg-red-500", text: "text-white", labelBg: "bg-red-100", labelText: "text-red-600",
            "title": "Optimizing Inventory with Predictive Analytics",
            "description": "A retail chain minimized stockouts and reduced overstock by 30% using predictive analytics to forecast demand and optimize inventory management.",
            "image": "https://images.unsplash.com/36/yJl7OB3sSpOdEIpHhZhd_DSC_1929_1.jpg?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fFJldGFpbHxlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            "category": "Logistics",
            bg: "bg-orange-500", text: "text-white", labelBg: "bg-orange-100", labelText: "text-orange-600",
            "title": "Streamlining Supply Chain with IoT",
            "description": "A logistics company improved delivery times by 25% by implementing IoT sensors for real-time tracking and automated route optimization.",
            "image": "https://images.unsplash.com/photo-1606964212858-c215029db704?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8TG9naXN0aWNzfGVufDB8fDB8fHww"
        },
        {
            "category": "Hospitality",
            bg: "bg-yellow-500", text: "text-white", labelBg: "bg-yellow-100", labelText: "text-yellow-600",
            "title": "Enhancing Customer Experience with Chatbots",
            "description": "A hotel chain enhanced customer experience by implementing AI chatbots for instant support, reducing response times by 60%.",
            "image": "https://plus.unsplash.com/premium_photo-1664189122884-59ad482873d6?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8SG9zcGl0YWxpdHl8ZW58MHx8MHx8fDA%3D"
        },
        {
            "category": "Real Estate",
            bg: "bg-teal-500", text: "text-white", labelBg: "bg-teal-100", labelText: "text-teal-600",
            "title": "Increasing Property Sales with Virtual Tours",
            "description": "A real estate agency increased property sales by 40% by offering virtual tours, allowing buyers to explore properties remotely.",
            "image": "https://images.unsplash.com/photo-1558036117-15d82a90b9b1?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fFJlYWwlMjBFc3RhdGV8ZW58MHx8MHx8fDA%3D"
        },
        {
            "category": "Automotive",
            bg: "bg-cyan-500", text: "text-white", labelBg: "bg-cyan-100", labelText: "text-cyan-600",
            "title": "Reducing Maintenance Costs with Predictive Maintenance",
            "description": "An automotive manufacturer reduced maintenance costs by 20% by implementing predictive maintenance powered by IoT sensors and machine learning.",
            "image": "https://images.unsplash.com/photo-1589320011103-48e428abcbae?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8QXV0b21vdGl2ZXxlbnwwfHwwfHx8MA%3D%3D"
        }
    ];
    ...
    const testimonials = [
        {
            ...
            "testimonial": "This product revolutionized our workflow. Our team's productivity has increased by 50%!",
        ...
        },
        {
            ...
            "testimonial": "The customer support was phenomenal! They helped us every step of the way.",
        ...
        },
        {
            ...
            "testimonial": "We saw a 30% increase in user engagement after integrating this solution. Highly recommended!",
        ...
        },
        {
            ...
            "testimonial": "Amazing features and easy to use. It helped us launch our product faster than expected.",
    ...
    const webProjects = [
        {
            ...
            "description": "A scalable e-commerce website with real-time inventory management, payment integration, and a user-friendly interface.",
            "technologies": ["React", "Node.js", "MongoDB", "Stripe API"],
            "image": "https://images.unsplash.com/photo-1481487196290-c152efe083f5?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8d2Vic2l0ZXxlbnwwfHwwfHx8MA%3D%3D",
            "link": "https://example-ecommerce.com"
        },
        {
            "title": "Social Media Dashboard",
            "description": "A comprehensive social media analytics dashboard with sentiment analysis and scheduling features.",
            "technologies": ["Vue.js", "Firebase", "Chart.js"],
            "image": "https://plus.unsplash.com/premium_photo-1720970650017-e39447272615?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8U29jaWFsJTIwTWVkaWElMjBEYXNoYm9hcmQlMjB3ZWJ8ZW58MHx8MHx8fDA%3D",
            "link": "https://example-social-dashboard.com"
        },
        {
            "title": "Fitness Mobile App",
            "description": "A cross-platform fitness app with personalized workout plans, diet tracking, and progress visualization.",
            "technologies": ["React Native", "Redux", "Firebase"],
            "image": "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fEZpdG5lc3MlMjBNb2JpbGUlMjBBcHB8ZW58MHx8MHx8fDA%3D",
            "link": "https://example-fitness-app.com"
        },
        {
            "title": "AI Chatbot Platform",
            "description": "An AI-powered chatbot for customer support with natural language processing and multilingual capabilities.",
            "technologies": ["Python", "TensorFlow", "Django", "NLP"],
            "image": "https://plus.unsplash.com/premium_photo-1726550550053-6e5f7190f1bf?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8QUklMjBDaGF0Ym90JTIwUGxhdGZvcm18ZW58MHx8MHx8fDA%3D",
            "link": "https://example-chatbot.com"
        },
        {
            "title": "Travel Booking Website",
            "description": "A travel booking platform with live pricing, detailed itineraries, and secure payment gateways.",
            "technologies": ["Angular", "Node.js", "MySQL"],
            "image": "https://images.unsplash.com/photo-1482059470115-0aadd6bf6834?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fFRyYXZlbCUyMEJvb2tpbmclMjBXZWJzaXRlfGVufDB8fDB8fHww",
            "link": "https://example-travel-booking.com"
        }
    ]
    ...
    const nextSlide = () => {
        const maxSlides = isMobile ?
            ...
            Math.ceil(webProjects.length / 2) - 1;
        setCurrentSlide(current =>
            current >= maxSlides ? 0 : current + 1
        );
    };
    ...
    // Add this useEffect for mouse tracking
    useEffect(() => {
    ...
    // Add these functions to handle cursor states
    ...
    return (
        <>
            ...
            >
                {/* Main cursor circle */}
                <div className={`relative ${cursorVariant === "default" ? '-left-3 -top-3 w-6 h-6' :
                    cursorVariant === "text" ? '-left-5 -top-5 w-10 h-10' :
                        '-left-6 -top-6 w-12 h-12'
                    } transition-all duration-100 ease-out rounded-full bg-white`} />

                {/* Animated outer rings */}
                <div className={`absolute ${cursorVariant === "default" ? '-left-3 -top-3 w-6 h-6' :
                    cursorVariant === "text" ? '-left-5 -top-5 w-10 h-10' :
                        '-left-6 -top-6 w-12 h-12'
                    } rounded-full border border-white animate-ripple-1 opacity-0`} />

                <div className={`absolute ${cursorVariant === "default" ? '-left-3 -top-3 w-6 h-6' :
                    cursorVariant === "text" ? '-left-5 -top-5 w-10 h-10' :
                        '-left-6 -top-6 w-12 h-12'
                    } rounded-full border border-white animate-ripple-2 opacity-0`} />
            </div>

            {/* Hide default cursor */}


            <header className={`fixed  w-full z-50 transition-all duration-300 ease-in-out ${isScrolled
                ? 'bg-black text-white shadow-lg'
                : 'bg-white text-black'
                }`}>
                <nav className="border-gray-200 py-2.5">
                    <div className="flex h-[5rem] flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                        <a href="#" className="flex items-center">
                            <span className={`self-center text-xl font-semibold whitespace-nowrap transition-colors duration-300 ${isScrolled ? 'text-white' : 'text-black dark:text-white'
                                }`}>
                                Logo
                            </span>
                        </a>
                        ...
                        <button
                            ...
                            className={`inline-flex items-center p-2 ml-3 text-sm rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 transition-colors duration-300 ${isScrolled
                                ? 'text-white hover:bg-gray-700 focus:ring-gray-600'
                                : 'text-gray-500 hover:bg-gray-100 focus:ring-gray-200'
                                }`}
                        >
                            <div className="relative w-6 h-6">
                                <span className={`absolute w-6 h-0.5 transform transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'rotate-45 top-3' : 'rotate-0 top-1'
                                    } ${isScrolled ? 'bg-white' : 'bg-black dark:bg-white'}`}></span>
                                <span className={`absolute w-6 h-0.5 transform transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'opacity-0' : 'opacity-100'
                                    } top-3 ${isScrolled ? 'bg-white' : 'bg-black dark:bg-white'}`}></span>
                                <span className={`absolute w-6 h-0.5 transform transition-all duration-300 ease-in-out ${isMobileMenuOpen ? '-rotate-45 top-3' : 'rotate-0 top-5'
                                    } ${isScrolled ? 'bg-white' : 'bg-black dark:bg-white'}`}></span>
                            </div>
                        </button>
                            ...
                            <ul className="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                                <li>
                                    <a
                                        ...
                                        onMouseEnter={linkEnter}
                                        onMouseLeave={linkLeave}
                                        className={`block py-2 pl-3 pr-4 rounded md:p-0 transition-colors duration-300 ${isScrolled
                        ...
                        {/* Mobile Menu Panel */}
                        <div
                            className={`fixed top-0 right-0 h-full w-64 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
                                        ...
                                        {[
                                            ...
                                            <li key={item.name}>
                                                <a
                                                    ...
                                                    className={`block text-lg font-medium transition-colors duration-300 ${isScrolled
                                                        ? 'text-white hover:text-gray-300'
                                                        : 'text-white hover:text-blue-600 dark:text-white dark:hover:text-blue-500'
                                                        }`}
                                                >
                                                    {item.name}
                                                </a>
            ...
            <section id="home" className="pt-[8rem] md:px-[10rem] lg:px-[10rem] bg-black dark:bg-gray-900 lg:py-16">
                <div className="grid max-w-screen-xl px-4  pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <div className="space-y-4 w-full sm:flex sm:space-y-0 sm:space-x-10">
                            <a
                                href="#"
                                className="h-[5rem]  bg-green-500 hover:text-white inline-flex items-center justify-center w-full px-10 py-3 mb-2 mr-2  text-gray-900 bg-green border border-gray-200 rounded-lg sm:w-max focus:outline-none"
                            >
                    ...
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src="./images/user-img.png" alt="hero image" />
                    </div>
                </div>
            </section>


            <section className="md:px-[10rem] lg:px-[10rem] bg-black dark:bg-gray-900 px-4">
                <div className="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
                    <span className="text-white text-2xl mb-10">Worked with</span>
                    <div className="grid grid-cols-2 mt-10 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
            ...
            <section id="case-studies" className="pt-[8rem] md:px-[10rem]  lg:px-[20rem] bg-white dark:bg-gray-900">
                <div className=" px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-10">
                    <div className="text-center mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="mb-8 md:px-20  font-light lg:text-xl">
                    ...
                    <div className=" max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 ">
                        {caseStudies.map((caseStudy, index) => {
                            // Random color combinations for buttons and labels
                                    ...
                                    {index % 2 === 0 ? (
                                        <>
                                            <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                                                <label className={`font-bold text-sm p-2 rounded-full mb-2 ${caseStudy.labelBg} ${caseStudy.labelText}`}>
                                                    {caseStudy.category}
                                                </label>
                                                <h2 className="mb-4 mt-2 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                                                    {caseStudy.title}
                                                </h2>
                                                ...
                                                <button
                                                    onMouseEnter={linkEnter}
                                                    onMouseLeave={linkLeave}
                                                    className={`flex items-center rounded-sm p-3 ${caseStudy.bg} ${caseStudy.text}`}
            ...
            <section id="testimonials" className="pt-[8rem] lg:px-[10rem] bg-black py-16 ">
                <div className="max-w-screen-xl mx-auto px-4 ">
                    <div className="text-center mb-16">
                        <h1 className=" text-white mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                            Testimonials
                        </h1>
                        <p className="mb-8 font-light text-gray-500 lg:text-xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {testimonials.map((testimonial, index) => (
                            <div key={index} className="relative p-[1px] rounded-lg bg-gradient-to-r from-[#484848] to-[#1B1B1B00]">
                                <div className="bg-black rounded-lg p-8 relative h-full">
                                    {/* Quote mark */}
                                    <div className="absolute -top-4 left-8 text-6xl text-white">"</div>
            ...
            <section id="recent-work" className="pt-[8rem] lg:px-[10rem] bg-white dark:bg-gray-800">
                <div className="px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-10">
                    <div className="text-center mr-auto place-self-center lg:col-span-7">
                        <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                            Recent Work
                    ...
                    {/* Two Carousels Container */}
                    <div className="relative gap-8 max-w-screen-xl mx-auto px-4 py-8">
                        {/* First Carousel */}
                        <div className="relative mx-[5rem]
                        ">
                            <h2 className="text-2xl font-bold text-white mb-6">Web Development</h2>
                            <div className="overflow-hidden relative rounded-lg">
                                <div
                                    ...
                                    {webProjects.map((project, index) => (
                                        <div key={index}
                                            className={`${isMobile ? 'min-w-full' : 'min-w-[50%]'} px-2`}>
                                            <div className=" rounded-lg overflow-hidden">
                                                ...
                                                <button className="bg-green-500 text-white px-4 py-2 rounded-md">Know More</button>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                        ...
                        <button
                            onClick={prevSlide}
                            className="absolute left-0 top-1/2 -translate-y-1/2 border-2 border-gray-600 rounded-full hover:text-white hover:border-white hover:bg-black/75 text-black p-4"
                        >
                        ...
                        <button
                            onClick={nextSlide}
                            className="absolute right-0 top-1/2 -translate-y-1/2 border-2 border-gray-600 rounded-full hover:text-white hover:border-white hover:bg-black/75 text-black p-4"
                        >
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <section id="get-in-touch" className="pt-[8rem] md:px-[10rem] text-white lg:px-[10rem] bg-black dark:bg-gray-800 pb-10">
                <div className="lg:px-[10rem] px-4  pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-10">
                    <div className="text-center mr-auto place-self-center lg:col-span-7">
                        <h1 className=" mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">
                            Get in Touch{" "}
                        </h1>
                ...
                <div className="flex justify-center">
                    <div className=" w-[100%] lg:w-[50%] bg-black dark:bg-gray-800 p-8 rounded-lg">
                        <form>
                            <div className="mb-4">
                                <label htmlFor="name" className="block mb-2 text-sm font-medium text-white dark:text-white">Name</label>
                                <input type="text" id="name" className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John Doe" required />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-white dark:text-white">Email</label>
                                <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="john.doe@example.com" required />
                            </div>
                            <div className="mb-4">
                                <label htmlFor="message" className="block mb-2 text-sm font-medium text-white dark:text-white">Message</label>
                            ...
                            <button type="submit" className="bg-green-500 text-white px-4 py-2 h-[5rem] rounded-md w-full">Send Message</button>
                        </form>
                    </div>
                </div>
            ...
            {isModalOpen && selectedCaseStudy && (
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl transform transition-all max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                            {/* Modal Header */}
                            ...
                            <div className="p-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300">
                                            {selectedCaseStudy.challenge || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 dark:text-gray-300">
                                            {selectedCaseStudy.solution || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."}
                                        </p>
                                    </div>
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-700 p-4">
                                <div className="flex justify-end space-x-3">
                                    ...
                                    <a
                                        ...
                                        className="hover:text-white px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                                    >
                                        Visit Project
                                    </a>
                                </div>
